...
// 设置页面标题和元数据
useHead({
  title: 'AI恋爱大喵 - Urim AI超级智能体应用平台',
  meta: [
    {
      name: 'description',
      content: 'AI恋爱大喵是Urim AI超级智能体应用平台的专业情感顾问，帮你解答各种恋爱问题，提供情感建议'
    },
    {
      name: 'keywords',
      content: 'AI恋爱大喵,情感顾问,恋爱咨询,AI聊天,情感问题,Urim ,AI智能体'
    }
  ]
})
...
onMounted(() => {
  ...
  // 添加欢迎消息
  addMessage('欢迎来到AI恋爱大喵，请告诉我你的恋爱问题，我会尽力给予帮助和建议。', false)
})
