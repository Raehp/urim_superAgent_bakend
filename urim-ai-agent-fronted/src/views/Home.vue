  ...
  <div class="home-container">
    <div class="header">
      <div class="glitch-wrapper">
        <h1 class="glitch-title">Urim AI超级智能猫</h1>
      </div>
    ...
    <div class="apps-container">
      ...
      <div class="app-card" @click="navigateTo('/super-agent')">
        ...
        <div class="app-info">
          <div class="app-title">AI超级智能猫</div>
...
// 设置页面标题和元数据
useHead({
  title: 'Urim AI超级智能猫应用平台 - 首页',
  meta: [
    {
      name: 'description',
      content: 'Urim AI超级智能猫应用平台提供AI恋爱大师和AI超级智能猫服务，满足您的各种AI对话需求'
    },
    {
      name: 'keywords',
      content: 'AI智能猫,AI应用,AI恋爱大师,AI助手,智能对话,Urim ,AI超级智能猫,首页'
    }
  ]
})
