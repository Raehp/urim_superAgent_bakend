...
useHead({
  ...
  meta: [
    {
      name: 'description',
      content: 'AI超级智能猫是Urim AI超级智能猫应用平台的全能助手，能解答各类专业问题，提供精准建议和解决方案'
    },
    {
      name: 'keywords',
      content: 'AI超级智能猫,智能助手,专业问答,AI问答,专业建议,Urim ,AI智能猫'
    }
  ]
})
...
onMounted(() => {
  // 添加欢迎消息
  addMessage('你好，我是AI超级智能猫。我可以解答各类问题，提供专业建议，请问有什么可以帮助你的吗？', false)
})
